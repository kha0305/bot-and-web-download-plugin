  ...
  async handle(interaction) {
    ...
    // --- TRANSLATE FILE INSTRUCTION ---
      ...
      await interaction.reply({
        content:
          "📁 **Hướng dẫn dịch file:**\n\n" +
          "1. Kéo thả file `.yml`, `.yaml` hoặc `.txt` vào chat\n" +
          "2. Sử dụng lệnh `/dich file:<file_đính_kèm>`\n" +
          "3. Chọn engine dịch (Google/ChatGPT) khi bot hỏi.\n\n" +
    ...
    // --- TRANSLATE TEXT (Google) ---
      ...
      const textInput = new TextInputBuilder()
        ...
        .setPlaceholder("Enter text to translate to Vietnamese...")
        .setStyle(TextInputStyle.Paragraph)
        .setRequired(true)
        .setMaxLength(2000);
